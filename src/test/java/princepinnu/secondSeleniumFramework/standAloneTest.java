...
//		driver.get("https://rahulshettyacademy.com/client");
		...
		landingPage.goTo();
		landingPage.loginApplication("princebabu@gmail.com", "Prince@2000");
//		driver.findElement(By.id("userEmail")).sendKeys("princebabu@gmail.com");
//		driver.findElement(By.id("userPassword")).sendKeys("Prince@2000");
